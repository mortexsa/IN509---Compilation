...
public:
  virtual int visit(const class IntegerLiteral &) = 0;
  virtual int visit(const class StringLiteral &) = 0;
  virtual int visit(const class BinaryOperator &) = 0;
  virtual int visit(const class Sequence &) = 0;
  virtual int visit(const class Let &) = 0;
  virtual int visit(const class Identifier &) = 0;
  virtual int visit(const class IfThenElse &) = 0;
  virtual int visit(const class VarDecl &) = 0;
  virtual int visit(const class FunDecl &) = 0;
  virtual int visit(const class FunCall &) = 0;
  virtual int visit(const class WhileLoop &) = 0;
  virtual int visit(const class ForLoop &) = 0;
  virtual int visit(const class Break &) = 0;
  virtual int visit(const class Assign &) = 0;
};
...
public:
  ...
  virtual int accept(ConstASTIntVisitor &visitor) const = 0;
};
...
public:
  ...
  virtual int accept(ConstASTIntVisitor &visitor) const {
